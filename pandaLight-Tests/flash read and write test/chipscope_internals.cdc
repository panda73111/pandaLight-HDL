...
Project.filter<3>=*mosi*
Project.filter<4>=*miso*
Project.filter<5>=SPI_FLASH_CONTROL_inst/cur_reg_state*
Project.filter<6>=SPI_FLASH_CONTROL*
...
Project.unit<0>.dataChannel<23>=SPI_FLASH_CONTROL_inst/next_data_byte<0>
Project.unit<0>.dataChannel<24>=SPI_FLASH_CONTROL_inst/next_data_byte<1>
Project.unit<0>.dataChannel<25>=SPI_FLASH_CONTROL_inst/next_data_byte<2>
Project.unit<0>.dataChannel<26>=SPI_FLASH_CONTROL_inst/next_data_byte<3>
Project.unit<0>.dataChannel<27>=SPI_FLASH_CONTROL_inst/next_data_byte<4>
Project.unit<0>.dataChannel<28>=SPI_FLASH_CONTROL_inst/next_data_byte<5>
Project.unit<0>.dataChannel<29>=SPI_FLASH_CONTROL_inst/next_data_byte<6>
Project.unit<0>.dataChannel<2>=SPI_FLASH_CONTROL_inst/cur_reg_state_FSM_FFd3
Project.unit<0>.dataChannel<30>=SPI_FLASH_CONTROL_inst/next_data_byte<7>
Project.unit<0>.dataChannel<31>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<0>
Project.unit<0>.dataChannel<32>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<1>
Project.unit<0>.dataChannel<33>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<2>
Project.unit<0>.dataChannel<34>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<3>
Project.unit<0>.dataChannel<35>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<4>
Project.unit<0>.dataChannel<36>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<5>
Project.unit<0>.dataChannel<37>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<6>
Project.unit<0>.dataChannel<38>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<7>
Project.unit<0>.dataChannel<39>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<8>
Project.unit<0>.dataChannel<3>=SPI_FLASH_CONTROL_inst/cur_reg_state_FSM_FFd4
Project.unit<0>.dataChannel<40>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<9>
Project.unit<0>.dataChannel<41>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<10>
Project.unit<0>.dataChannel<42>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<11>
Project.unit<0>.dataChannel<43>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<12>
Project.unit<0>.dataChannel<44>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<13>
Project.unit<0>.dataChannel<45>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<14>
Project.unit<0>.dataChannel<46>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<15>
Project.unit<0>.dataChannel<47>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<16>
Project.unit<0>.dataChannel<48>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<17>
Project.unit<0>.dataChannel<49>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<18>
Project.unit<0>.dataChannel<4>=SPI_FLASH_CONTROL_inst/cur_reg_state_FSM_FFd5
Project.unit<0>.dataChannel<50>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<19>
Project.unit<0>.dataChannel<51>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<20>
Project.unit<0>.dataChannel<52>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<21>
Project.unit<0>.dataChannel<53>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<22>
Project.unit<0>.dataChannel<54>=SPI_FLASH_CONTROL_inst/cur_reg_cur_addr<23>
Project.unit<0>.dataChannel<55>=SPI_FLASH_CONTROL_inst/cur_reg_desel_tick_count<0>
Project.unit<0>.dataChannel<56>=SPI_FLASH_CONTROL_inst/cur_reg_desel_tick_count<1>
Project.unit<0>.dataChannel<57>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<0>
Project.unit<0>.dataChannel<58>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<1>
Project.unit<0>.dataChannel<59>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<2>
Project.unit<0>.dataChannel<5>=SPI_FLASH_CONTROL_inst/cur_reg_state_FSM_FFd6
Project.unit<0>.dataChannel<60>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<3>
Project.unit<0>.dataChannel<61>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<4>
Project.unit<0>.dataChannel<62>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<5>
Project.unit<0>.dataChannel<63>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<6>
Project.unit<0>.dataChannel<64>=SPI_FLASH_CONTROL_inst/cur_reg_poll_tick_count<7>
Project.unit<0>.dataChannel<65>=SPI_FLASH_CONTROL_inst/cur_reg_fifo_rd_en
Project.unit<0>.dataChannel<66>=SPI_FLASH_CONTROL_inst/cur_reg_mosi
Project.unit<0>.dataChannel<67>=SPI_FLASH_CONTROL_inst/cur_reg_sn
Project.unit<0>.dataChannel<68>=SPI_FLASH_CONTROL_inst/cur_reg_valid
Project.unit<0>.dataChannel<69>=SPI_FLASH_CONTROL_inst/more_bytes_to_send
...
Project.unit<0>.triggerChannel<4><0>=SPI_FLASH_CONTROL_inst/next_data_byte<0>
Project.unit<0>.triggerChannel<4><1>=SPI_FLASH_CONTROL_inst/next_data_byte<1>
Project.unit<0>.triggerChannel<4><2>=SPI_FLASH_CONTROL_inst/next_data_byte<2>
Project.unit<0>.triggerChannel<4><3>=SPI_FLASH_CONTROL_inst/next_data_byte<3>
Project.unit<0>.triggerChannel<4><4>=SPI_FLASH_CONTROL_inst/next_data_byte<4>
Project.unit<0>.triggerChannel<4><5>=SPI_FLASH_CONTROL_inst/next_data_byte<5>
Project.unit<0>.triggerChannel<4><6>=SPI_FLASH_CONTROL_inst/next_data_byte<6>
Project.unit<0>.triggerChannel<4><7>=SPI_FLASH_CONTROL_inst/next_data_byte<7>
