...
Project.filter<0>=*flash_control*
Project.filter<10>=*cmd_eval_state*
Project.filter<11>=*cms_eval_state*
Project.filter<12>=
Project.filter<13>=*bitfile_index*
Project.filter<14>=*bitfile_index
Project.filter<15>=bitfile_index
Project.filter<16>=*start*
Project.filter<17>=g_clk
Project.filter<18>=gclk
Project.filter<1>=*flash_ctrl*
Project.filter<2>=*fctrl*
Project.filter<3>=*fctrl_addr*
Project.filter<4>=*fctrl_din*
Project.filter<5>=*bitfile_addr*
Project.filter<6>=*bitfile_address*
Project.filter<7>=*state*
Project.filter<8>=*data_handling_counter*
Project.filter<9>=*data_handling_state*
