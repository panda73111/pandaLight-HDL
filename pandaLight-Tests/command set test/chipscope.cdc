...
Project.filter<0>=start*
Project.filter<10>=*write_buffer_inst*
Project.filter<11>=*count*
Project.filter<12>=*counter*
Project.filter<13>=*flash_control*
Project.filter<14>=*flash_ctrl*
Project.filter<15>=*fctrl*
Project.filter<16>=*fctrl_addr*
Project.filter<17>=*fctrl_din*
Project.filter<18>=*bitfile_addr*
Project.filter<1>=
Project.filter<2>=*AFULL*
Project.filter<3>=SPI_FLASH_CONTROL_inst/*
Project.filter<4>=*afull*
Project.filter<5>=*cnt*
Project.filter<6>=*rts*
Project.filter<7>=*usb*
Project.filter<8>=*usb
Project.filter<9>=*rtsn*
